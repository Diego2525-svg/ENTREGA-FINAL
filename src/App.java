...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Crear nodos
        NodeGraph node1 = new NodeGraph(user1);
        NodeGraph node2 = new NodeGraph(user2);
        NodeGraph node3 = new NodeGraph(user3);
        NodeGraph node4 = new NodeGraph(user4);
        NodeGraph node5 = new NodeGraph(user5);
        ...
        System.out.println("Recomendaciones de amigos "+node1.getUser()+" son "+recommendations);
